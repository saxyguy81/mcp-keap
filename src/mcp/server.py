            ...
            schema = {
                "contacts": {
                    "fields": {
                        ...
                        "first_name": {"type": "string", "description": "First name (given name)"},
                        "last_name": {"type": "string", "description": "Last name (family name)"},
                        "email": {"type": "string", "description": "Primary email address"},
                        "date_created": {"type": "string", "format": "date-time", "description": "When the contact was created"},
                        "date_updated": {"type": "string", "format": "date-time", "description": "When the contact was last updated"},
                        "tag": {"type": "tag", "description": "Tag filter"},
                        "tag_applied": {"type": "tag_date", "description": "Tag application date filter"},
                        "custom_field": {"type": "custom", "description": "Custom field filter"}
                    },
                    "operators": {
                        "string": ["=", "!=", "pattern", "starts_with", "ends_with", "contains", "in"],
                        "numeric": ["=", "!=", "<", "<=", ">", ">=", "in", "between"],
                        "date": ["=", "!=", "<", "<=", ">", ">=", "between", "before", "after", "on"],
                        "logical": ["AND", "OR", "NOT"]
                    }
                },
                "tags": {
                ...
                "filter_examples": [
                    ...
                    {"field": "date_created", "operator": ">=", "value": "2023-01-01T00:00:00Z"},
                    {"field": "date_created", "operator": "<=", "value": "2023-12-31T23:59:59Z"},
                    {
                        "operator": "OR",
                        "conditions": [
                            {"field": "first_name", "operator": "pattern", "value": "Matt*"},
                            {"field": "first_name", "operator": "pattern", "value": "David*"}
                        ]
                    },
                    {
                        "field": "tag",
                        ...
                        "value": {
                            ...
                            "conditions": [
                                {"tag_id": 123},
                                {
                                    ...
                                    "conditions": [
                                        {"tag_id": 456},
                                        {"operator": "NOT", "conditions": [{"tag_id": 789}]}
                                    ]
                                }
                            ]
                        }
                    },
                    {"field": "tag_applied", "operator": "before", "value": {"tag_id": 123, "value": "2023-06-01T00:00:00Z"}},
                    {"field": "custom_field", "operator": "pattern", "value": {"id": 1, "value": "New*Customer"}}
                ]
            }
