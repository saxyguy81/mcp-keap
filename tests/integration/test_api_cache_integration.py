...
class TestApiCacheIntegration:
    ...
    @pytest.mark.asyncio
    async def test_cache_expiration_triggers_api_call(self, mock_api_client, cache_manager):
    ...
    @pytest.mark.asyncio
    async def test_cache_invalidation_with_api_updates(self, mock_api_client, cache_manager):
    ...
    @pytest.mark.asyncio
    async def test_concurrent_api_cache_operations(self, mock_api_client, cache_manager):
    ...
    @pytest.mark.asyncio
    async def test_api_error_handling_with_cache_fallback(self, mock_api_client, cache_manager):
    ...
    @pytest.mark.asyncio
    async def test_cache_performance_with_large_datasets(self, mock_api_client, cache_manager):
    ...
    @pytest.mark.asyncio
    async def test_api_diagnostics_integration_with_cache(self, mock_api_client, cache_manager):
