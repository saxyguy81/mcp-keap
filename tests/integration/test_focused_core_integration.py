...
class TestFocusedCoreIntegration:
    ...
    @pytest.mark.asyncio
    async def test_contact_utils_comprehensive_integration(self, comprehensive_contact_data):
        ...
        include_fields = [
            ...
            "tag_ids", "addresses", "company", "date_created"
        ]
    ...
    @pytest.mark.asyncio
    async def test_filter_utils_comprehensive_integration(self, comprehensive_contact_data):
        ...
        not_equals_condition = {"field": "given_name", "operator": "!=", "value": "Jane"}
        assert evaluate_filter_condition(john_contact, not_equals_condition) is True
        
        # Test string operators
        contains_condition = {"field": "email_addresses.0.email", "operator": "contains", "value": "@example"}
        assert evaluate_filter_condition(john_contact, contains_condition) is True
        
        starts_with_condition = {"field": "given_name", "operator": "starts_with", "value": "Jo"}
        try:
    ...
    async def test_mcp_server_integration(self):
        ...
        expected_tools = [
            ...
            "search_contacts_by_name", "get_contact_details", 
    ...
    @pytest.mark.asyncio
    async def test_concurrent_filter_operations_integration(self, comprehensive_contact_data):
    ...
    @pytest.mark.asyncio  
    async def test_data_transformation_integration(self, comprehensive_contact_data, comprehensive_tag_data):
