...
class TestGetPrimaryEmail:
    ...
    def test_get_primary_email_with_primary_email(self):
        ...
        contact = {
            "email_addresses": [
                ...
                {"field": "EMAIL", "email": "primary@example.com", "is_primary": True},
            ]
        }
    ...
    def test_get_primary_email_fallback_to_first(self):
        ...
        contact = {
            "email_addresses": [
                {"field": "EMAIL", "email": "first@example.com"},
                {"field": "EMAIL", "email": "second@example.com"},
            ]
        }
    ...
    def test_get_primary_email_no_email_addresses(self):
        ...
        contact = {"given_name": "John", "family_name": "Doe"}
    ...
    def test_get_primary_email_non_email_fields(self):
        ...
        contact = {
            "email_addresses": [
                {"field": "OTHER", "email": "other@example.com"},
                {"field": "EMAIL", "email": "correct@example.com"},
            ]
        }
    ...
    def test_get_primary_email_missing_email_value(self):
        ...
        contact = {
            "email_addresses": [
                ...
                {"field": "EMAIL", "email": "fallback@example.com"},
            ]
        }
...
class TestGetFullName:
    ...
    def test_get_full_name_empty_names(self):
        ...
        contact = {"given_name": "", "family_name": ""}
...
class TestGetTagIds:
    ...
    def test_get_tag_ids_invalid_values(self):
        ...
        contact = {"tag_ids": ["100", "invalid", "102", None]}
...
class TestGetCustomFieldValue:
    ...
    def test_get_custom_field_value_not_found(self):
        ...
        contact = {"custom_fields": [{"id": "10", "content": "Value 1"}]}
...
class TestFormatContactSummary:
    ...
    def test_format_contact_summary_complete(self):
        ...
        contact = {
            ...
            "family_name": "Doe",
            "email_addresses": [
                {"field": "EMAIL", "email": "john@example.com", "is_primary": True}
            ],
    ...
    def test_format_contact_summary_partial_data(self):
        ...
        contact = {
            "given_name": "Jane",
            "email_addresses": [{"field": "EMAIL", "email": "jane@example.com"}],
            "tags": [{"id": "200", "name": "Customer"}],
        }
...
class TestContactUtilsEdgeCases:
    ...
    def test_complex_email_scenarios(self):
        ...
        contact = {
            "email_addresses": [
                ...
                {"field": "EMAIL", "email": "work@example.com"},
                {
                    "field": "EMAIL",
    ...
    def test_unicode_and_special_characters(self):
        ...
        contact = {
            ...
            "email_addresses": [
                {"field": "EMAIL", "email": "josé@García-López.com", "is_primary": True}
            ],
        }
    ...
    def test_malformed_data_resilience(self):
        ...
        contact = {
            "email_addresses": [{"field": "EMAIL", "email": "valid@example.com"}]
        }
