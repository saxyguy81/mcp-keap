...
class TestPersistentCacheBasics:
    ...
    def test_cache_initialization(self, temp_cache_db):
        ...
        cache = PersistentCacheManager(
            db_path=temp_cache_db, max_entries=100, max_memory_mb=5
        )
...
class TestCacheInvalidation:
    ...
    def test_contact_id_tracking(self, cache_manager):
        ...
        contact_data1 = {"contact_ids": [1, 2, 3], "contacts": [{"id": 1}, {"id": 2}]}
        contact_data2 = {"contacts": [{"id": 2}, {"id": 4}]}
    ...
    def test_tag_id_tracking(self, cache_manager):
        ...
        tag_data1 = {"tag_ids": [100, 101], "tags": [{"id": 100}, {"id": 101}]}
        tag_data2 = {"tags": [{"id": 101}, {"id": 102}]}
...
class TestCacheThreadSafety:
    ...
    def test_concurrent_invalidation(self, cache_manager):
        ...
        for i in range(100):
            contact_data = {"contacts": [{"id": i}, {"id": i + 100}]}
