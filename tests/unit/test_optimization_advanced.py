...
class TestQueryExecutorAdvanced:
    ...
    @pytest.mark.asyncio
    async def test_execute_optimized_query_list_contacts(self, query_executor, mock_api_client):
    ...
    @pytest.mark.asyncio
    async def test_execute_optimized_query_get_tags(self, query_executor, mock_api_client):
    ...
    @pytest.mark.asyncio
    async def test_execute_optimized_query_with_cache_hit(self, query_executor, mock_cache_manager):
...
class TestOptimizationResult:
    ...
    def test_optimization_result_creation(self):
        ...
        server_filters = [{"field": "email", "operator": "=", "value": "test@example.com"}]
