...
from src.utils.filter_utils import (
    ...
    evaluate_logical_group, apply_complex_filters, get_nested_value, 
    parse_date_value, optimize_filters_for_api
)
...
class TestOptimizeFiltersForApi:
    ...
    def test_optimize_mixed_filters(self):
        ...
        filters = [
            {"field": "email", "operator": "=", "value": "john@example.com"},  # API optimizable
            {"field": "given_name", "operator": "=", "value": "John"},  # API optimizable
            {"field": "custom_field", "operator": "=", "value": "VIP"}  # Client-side only
        ]
