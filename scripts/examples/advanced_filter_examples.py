...
async def main():
            ...
            "conditions": [
                {
                    ...
                    "conditions": [
                        ...
                        {"field": "given_name", "operator": "STARTS_WITH", "value": "John"}
                    ]
                },
                {
                    "field": "family_name", 
    ...
    optimizable_result = optimizer.optimize_contact_query_parameters(optimizable_filters)
    ...
    print(f"Estimated data reduction: {optimizable_result.estimated_data_reduction_ratio:.1%}")
    ...
    advanced_operators = [
        ...
        {"field": "date_created", "operator": "BETWEEN", "value": ["2024-01-01", "2024-12-31"]},
    ...
    for field, info in contact_capabilities.items():
        print(f"  {field}: {info['supported_operators']} (reduces data by {info['estimated_reduction']:.1%})")
            ...
            "filters": [
                {
                    ...
                    "conditions": [
                        {"field": "tags", "operator": "CONTAINS", "value": "premium"},
                        {"field": "custom_field_5", "operator": "GREATER_THAN", "value": 1000}
                    ]
                }
            ]
        }
    ...
    mcp_examples = {
            ...
            "params": {
                "filters": [
                    {"field": "email", "operator": "CONTAINS", "value": "@company.com"},
                    {
                        ...
                        "conditions": [
                            {"field": "given_name", "operator": "STARTS_WITH", "value": "John"},
                            {"field": "given_name", "operator": "STARTS_WITH", "value": "Jane"}
                        ]
                    }
                ],
                "limit": 50,
        ...
        "id_list_intersection": {
            ...
            "params": {
                "lists": [
                    {"list_id": "premium_customers", "item_ids": ["1", "2", "3", "4", "5"]},
                    {"list_id": "recent_purchases", "item_ids": ["3", "4", "5", "6", "7"]},
                    {"list_id": "email_subscribers", "item_ids": ["1", "3", "5", "7", "9"]}
                ],
                "id_field": "item_ids"
            }
        }
